    ...
    <div dir="rtl" className="mt-10 px-4 md:px-10">
      ...
      <div className="bg-white p-4 md:p-6 flex flex-col gap-4 border rounded-2xl shadow-md">
        ...
        <p className="text-justify leading-relaxed">
          در صورت بروز هرگونه مشکل در فرآیند ثبت سفارش، پرداخت آنلاین، یا
          استفاده از خدمات وب‌سایت، می‌توانید از طریق پشتیبانی آنلاین ما اقدام
          نمایید. همچنین از طریق تلگرام نیز در دسترس هستیم تا در سریع‌ترین زمان
          ممکن به سوالات و مشکلات شما رسیدگی کنیم. کارشناسان ما آماده‌اند تا در
          تمام مراحل خرید همراه شما باشند و بهترین خدمات را ارائه دهند.
        </p>
