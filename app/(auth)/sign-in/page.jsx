      ...
      <div className="w-[400px] h-[380px] relative">
        ...
        <div className="absolute bottom-0 w-full h-[340px] bg-white border-2 border-green-200 rounded-[30px] p-[25px] flex flex-col shadow-xl">
          ...
          <div className="flex justify-between mt-[10px] text-gray-600 text-md">
            <p className="text-right mt-[20px] text-gray-600">
              <Link
                onClick={t}
                href={"/create-account"}
            ...
            <p className="text-left mt-[20px] text-gray-600">
              <a
                onClick={v}
                className="text-green-600 mr-1 cursor-pointer hover:text-green-700 transition-colors duration-300"
              >
                ارسال دوباره کد
              </a>
            </p>
